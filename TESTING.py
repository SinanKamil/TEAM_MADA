...
#page 1 here:
        ...
        self.pages["page1"] = tk.Frame(self, bg="white")
        self.add_background_image(self.pages["page1"], "images/home_page.png")

        # Create the button to go to slideshow
        self.next_button_img1 = self.images["images/slideshow_btn.png"]
        self.next_button = tk.Button(self.pages["page1"], image=self.next_button_img1, activebackground ='white', background ='white', command=self.slideshow, highlightthickness = 0, highlightbackground = '#ffffff', borderwidth=None, relief="flat", bd=0)
        ...
        self.switch_button = tk.Button(self.pages["page1"], image=self.switch_button_img_on, command=self.fuel_toggle_switch, highlightthickness=0,
        ...
        self.switch_button_img_on1 = self.images["btn_images/directional_antenna.png"]
        self.switch_button1 = tk.Button(self.pages["page1"], image=self.switch_button_img_on1, command=self.dir_toggle_switch, highlightthickness=0,
                                     activebackground ='#092a81', background ='#092a81', borderwidth=0,
                                     relief="flat", bd=0)
        self.switch_button1.place(x=765, y=450)
        # This is for the aileron smart servo
        self.switch_button_img_on2 = self.images["btn_images/aileron.png"]
        self.switch_button2 = tk.Button(self.pages["page1"], image=self.switch_button_img_on2, command=self.aileron_toggle_switch,
        ...
        self.switch_button_img_on4 = self.images["btn_images/landing_gear.png"]
        self.switch_button4 = tk.Button(self.pages["page1"], image=self.switch_button_img_on4,
        ...
        self.switch_button_img_on5 = self.images["btn_images/alternator.png"]
        self.switch_button5 = tk.Button(self.pages["page1"], image=self.switch_button_img_on5,
...
# page 2 here:
        ...
        self.pages["page2"] = tk.Frame(self, bg="white")
        self.add_background_image(self.pages["page2"], "images/admin_access.png")

        # Create the button to go to page 2
        self.next_button_img = self.images["images/adminlogin_btn.png"]
        self.adminlogin_btn = tk.Button(self.pages["page1"], image=self.next_button_img, activebackground='white',
        ...
        self.next_button = tk.Button(self.pages["page2"], image=self.next_button_img2, highlightthickness = 0, activebackground ='white', background ='white', command=self.show_page1, borderwidth=0, relief="flat", bd=0)
        self.next_button.place(x=222, y=882)

        self.label = tk.Label(self.pages["page2"], font=("Arial", 20))
        ...
        # one
        self.next_button_img3 = self.images["keypad_num_images/1.png"]
        self.next_button = tk.Button(self.pages["page2"], image=self.next_button_img3, highlightthickness=0,
        ...
        self.next_button = tk.Button(self.pages["page2"], image=self.next_button_img4, highlightthickness=0,
        ...
        # three
        self.next_button_img5 = self.images["keypad_num_images/3.png"]
        self.next_button = tk.Button(self.pages["page2"], image=self.next_button_img5, highlightthickness=0,
                                     activebackground='white', background='white', command=lambda: self.store(3),
                                     borderwidth=0,
                                     relief="flat", bd=0)
        self.next_button.place(x=1025, y=365)
        # four
        self.next_button_img7 = self.images["keypad_num_images/4.png"]
        self.next_button = tk.Button(self.pages["page2"], image=self.next_button_img7, highlightthickness=0,
                                     activebackground='white', background='white', command=lambda: self.store(4),
                                     borderwidth=0,
                                     relief="flat", bd=0)
        self.next_button.place(x=720, y=500)
        # five
        self.next_button_img8 = self.images["keypad_num_images/5.png"]
        self.next_button = tk.Button(self.pages["page2"], image=self.next_button_img8, highlightthickness=0,
        ...
        # six
        self.next_button_img9 = self.images["keypad_num_images/6.png"]
        self.next_button = tk.Button(self.pages["page2"], image=self.next_button_img9, highlightthickness=0,
                                     activebackground='white', background='white', command=lambda: self.store(6),
                                     borderwidth=0,
                                     relief="flat", bd=0)
        self.next_button.place(x=1040, y=500)
        # seven
        self.next_button_img10 = self.images["keypad_num_images/7.png"]
        self.next_button = tk.Button(self.pages["page2"], image=self.next_button_img10, highlightthickness=0,
                                     activebackground='white', background='white', command=lambda: self.store(7),
                                     borderwidth=0,
                                     relief="flat", bd=0)
        self.next_button.place(x=720, y=640)
        # eight
        self.next_button_img11 = self.images["keypad_num_images/8.png"]
        self.next_button = tk.Button(self.pages["page2"], image=self.next_button_img11, highlightthickness=0,
        ...
        # nine
        self.next_button_img12 = self.images["keypad_num_images/9.png"]
        self.next_button = tk.Button(self.pages["page2"], image=self.next_button_img12, highlightthickness=0,
        ...
        # zero
        self.next_button_img13 = self.images["keypad_num_images/0.png"]
        self.next_button = tk.Button(self.pages["page2"], image=self.next_button_img13, highlightthickness=0,
        ...
        # Clear
        self.next_button_img14 = self.images["keypad_num_images/clear.png"]
        self.next_button = tk.Button(self.pages["page2"], image=self.next_button_img14, highlightthickness=0,
        ...
        # Enter button
        self.next_button_img6 = self.images["images/Enter_btn.png"]
        self.next_button = tk.Button(self.pages["page2"], image=self.next_button_img6, highlightthickness = 0, activebackground ='white', background ='white', command=self.checkpasscode, borderwidth=0, relief="flat", bd=0)
        self.next_button.place(x=1432, y=882)

#page 3
        self.pages["page3"] = tk.Frame(self, bg="white")
        self.add_background_image(self.pages["page3"], "images/admin_page.png")

        self.next_button_img17 = self.images["images/homemenu_btn.png"]
        self.next_button = tk.Button(self.pages["page3"], image=self.next_button_img17, highlightthickness=0,
        ...
        self.next_button = tk.Button(self.pages["page3"], image=self.exit_btn, highlightthickness=0,
                                     activebackground='#092a81', background='#092a81', command=self.exit,
                                     borderwidth=0, relief="flat", bd=0)
        self.next_button.place(x=1700, y=50)

#page for fuel pump
        self.pages["fuel_pump_page"] = tk.Frame(self, bg="white")
        self.add_background_image(self.pages["fuel_pump_page"], "images/fuel_pump_page.png")

        self.next_button_img18 = self.images["btn_images/fuel_pump.png"]
        self.next_button = tk.Button(self.pages["page3"], image=self.next_button_img18, highlightthickness=0,
        ...
        self.switch_button_fuel = tk.Button(self.pages["fuel_pump_page"], image=self.switch_button_fuel_off, command=self.fuelpump_on_off,
                                       highlightthickness=0,
                                       activebackground='#092a81', background='#092a81', borderwidth=0,
                                       relief="flat", bd=0)
        ...
        self.next_button = tk.Button(self.pages["fuel_pump_page"], image=self.next_button_img19, highlightthickness=0,
                                       activebackground='white', background='white', command=self.show_page3,
                                       borderwidth=0, relief="flat", bd=0)
        self.next_button.place(x=230, y=884)

#page for alternator
        self.pages["alternator_page"] = tk.Frame(self, bg="white")
        self.add_background_image(self.pages["alternator_page"], "images/alternator_page.png")

        self.alternator_img_btn = self.images["btn_images/alternator.png"]
        self.alternator_btn = tk.Button(self.pages["page3"], image=self.alternator_img_btn, highlightthickness=0,
        ...
        self.w1 = Scale(self.pages["alternator_page"], from_=0, to=100, length=1000, orient=HORIZONTAL, #command=self.slider_function,
        ...
        self.value_label = Label(self.pages["alternator_page"], text=self.current_value, font=("Tactic Sans Extra Extended", 25), fg='white', bg="#092a81")
        self.value_label.pack()
        self.value_label.place(x=935, y=450)
    

        self.back = self.images["images/adminmenu_btn.png"]
        self.next_button = tk.Button(self.pages["alternator_page"], image=self.back, highlightthickness=0,
                                     activebackground='white', background='white', command=self.show_page3,
                                     borderwidth=0, relief="flat", bd=0)
        self.next_button.place(x=230, y=884)
# page for landing gear
        self.pages["landing_gear_page"] = tk.Frame(self, bg="white")
        self.add_background_image(self.pages["landing_gear_page"], "images/landing_gear_page.png")


        self.landing_gear_btn = self.images["btn_images/landing_gear.png"]
        self.landing_gear_btn_fun = tk.Button(self.pages["page3"], image=self.landing_gear_btn, highlightthickness=0,
        ...
        self.next_button = tk.Button(self.pages["landing_gear_page"], image=self.back1, highlightthickness=0,
                                     activebackground='white', background='white', command=self.show_page3,
                                     borderwidth=0, relief="flat", bd=0)
        self.next_button.place(x=234, y=884)

        self.left = self.images["btn_images/steer_left.png"]
        self.left_steering = tk.Button(self.pages["landing_gear_page"], image=self.left, highlightthickness=0,
        ...
        self.right_steering = tk.Button(self.pages["landing_gear_page"], image=self.right, highlightthickness=0,
                                     activebackground='#092a81', background='#092a81',
                                     borderwidth=0, relief="flat", bd=0)
        ...
        self.center_landing = tk.Button(self.pages["landing_gear_page"], image=self.center, highlightthickness=0,command=self.center_landing_gear,
                                     activebackground='#092a81', background='#092a81',
                                     borderwidth=0, relief="flat", bd=0)
        self.center_landing.place(x=800, y=500)

        self.retract_down = self.images["btn_images/retract_down.png"]
        self.next_button = tk.Button(self.pages["landing_gear_page"], image=self.retract_down, highlightthickness=0,
        ...
        self.next_button = tk.Button(self.pages["landing_gear_page"], image=self.retract_up, highlightthickness=0,
...
#page for Aileron Smart Servo
        ...
        self.pages["aileron_servo_page"] = tk.Frame(self, bg="white")
        self.add_background_image(self.pages["aileron_servo_page"], "images/aileron_page.png")

        self.aileron_btn = self.images["btn_images/aileron.png"]
        self.next_button = tk.Button(self.pages["page3"], image=self.aileron_btn, highlightthickness=0,
                                     activebackground='#092a81', background='#092a81', command=self.show_aileron_servo_page,
                                     borderwidth=0, relief="flat", bd=0)
        self.next_button.place(x=1188, y=450)

        self.aileron_speed = Scale(self.pages["aileron_servo_page"], from_=100, to=0, length=360, orient=VERTICAL,
        ...
        self.aileron_value_label = Label(self.pages["aileron_servo_page"], text=self.aileron_speed_value, font=("Tactic Sans Extra Extended", 25),
                                 fg='white', bg="#092a81")
        ...
        self.next_button = tk.Button(self.pages["aileron_servo_page"], image=self.center_aileron_img, highlightthickness=0,
        ...
        self.next_button = tk.Button(self.pages["aileron_servo_page"], image=self.down_aileron_img, highlightthickness=0,
        ...
        self.next_button = tk.Button(self.pages["aileron_servo_page"], image=self.up_aileron_img, highlightthickness=0,
        ...
        self.next_button = tk.Button(self.pages["aileron_servo_page"], image=self.back2, highlightthickness=0,
                                     activebackground='white', background='white', command=self.show_page3,
                                     borderwidth=0, relief="flat", bd=0)
        self.next_button.place(x=230, y=884)
# page for Directional Antenna
        self.pages["directional_antenna_page"] = tk.Frame(self, bg="white")
        self.add_background_image(self.pages["directional_antenna_page"], "images/directional_antenna_page.png")
        self.show_page(self.pages["page1"])
        self.directional_antenna_btn = self.images["btn_images/directional_antenna.png"]
        self.next_button = tk.Button(self.pages["page3"], image=self.directional_antenna_btn, highlightthickness=0,
                                     activebackground='#092a81', background='#092a81',
                                     command=self.show_directional_antenna_page,
                                     borderwidth=0, relief="flat", bd=0)
        self.next_button.place(x=765, y=450)

        self.left_antenna_img = self.images["btn_images/antenna_left.png"]
        self.left_antenna_btn = tk.Button(self.pages["directional_antenna_page"], image=self.left_antenna_img, highlightthickness=0,
                                     activebackground='#092a81', background='#092a81',
                                     borderwidth=0, relief="flat", bd=0)
        ...
        self.right_antenna_img = self.images["btn_images/antenna_right.png"]
        self.right_antenna_btn = tk.Button(self.pages["directional_antenna_page"], image=self.right_antenna_img, highlightthickness=0,
                                     activebackground='#092a81', background='#092a81',
                                     borderwidth=0, relief="flat", bd=0)
        ...
        self.back3 = self.images["images/adminmenu_btn.png"]
        self.next_button = tk.Button(self.pages["directional_antenna_page"], image=self.back3, highlightthickness=0,
                                     activebackground='white', background='white', command=self.show_page3,
                                     borderwidth=0, relief="flat", bd=0)
        self.next_button.place(x=230, y=884)
    ...
    def show_page(self, page):
        # iterate over all pages in the dictionary and call pack_forget
        for p in self.pages.values():
            p.pack_forget()

        # pack the specified page
        page.pack(side="top", fill="both", expand=True)

    def show_fuel_pump_page(self):
        self.show_page(self.pages["fuel_pump_page"])
        self.reset_timer()
        self.update_label()
    def show_aileron_servo_page(self):
        self.show_page(self.pages["aileron_servo_page"])
        self.reset_timer()
        self.update_label()
    def show_alternator_page(self):
        self.show_page(self.pages["alternator_page"])
        self.reset_timer()
        self.update_label()
    def show_landing_gear_page(self):
         self.show_page(self.pages["landing_gear_page"])
         self.reset_timer()
         self.update_label()
    def show_directional_antenna_page(self):
        self.show_page(self.pages["directional_antenna_page"])
        self.reset_timer()
        self.update_label()
    def show_page2(self):
        self.show_page(self.pages["page2"])
        self.reset_timer()
        self.update_label()
    def show_page3(self):
        self.show_page(self.pages["page3"])
        self.reset_timer()
        self.update_label()
